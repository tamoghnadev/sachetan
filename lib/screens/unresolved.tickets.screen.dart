...
class UnResolvedTicketsScreen extends StatefulWidget {
  @override
  _UnResolvedTicketsScreenState createState() =>
      _UnResolvedTicketsScreenState();
}

class _UnResolvedTicketsScreenState extends State<UnResolvedTicketsScreen> {
  ...
  void initState() {
    super.initState();
    _getUnReSolvedTickets();
  }

  _getUnReSolvedTickets() async {
    try {
      ...
      var result = await _ticketService
          .getUnResolvedTicketsByUserId(_prefs!.getInt('userId')!);
                      ...
                      Padding(
                        ...
                        child: ButtonTheme(
                          ...
                          child: TextButton(
                            onPressed: () async {
                              Navigator.pop(context);
                              _confirm(context, ticket, '${getTranslated(context, 'ReOpen')}',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('${getTranslated(context, 'UnResolved Tickets')}'),
        actions: <Widget>[
          _isCustomer == true
              ? InkWell(
                  onTap: () {
        ...
        child: _isLoading == false
            ? Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    columns: [
                      DataColumn(label: Text('${getTranslated(context, 'Subject')}')),
                      DataColumn(label: Text('${getTranslated(context, 'Priority')}')),
