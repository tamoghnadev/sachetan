...
class ResolvedTicketsScreen extends StatefulWidget {
  @override
  _ResolvedTicketsScreenState createState() => _ResolvedTicketsScreenState();
}

class _ResolvedTicketsScreenState extends State<ResolvedTicketsScreen> {
  ...
  _getResolvedTickets() async {
    try {
      ...
      var result = await _ticketService
          .getResolvedTicketsByUserId(_prefs!.getInt('userId'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('${getTranslated(context, 'Resolved Tickets')}'),
        actions: <Widget>[
          _isCustomer == true
              ? InkWell(
                  onTap: () {
