...
import 'package:m_ticket_app/services/complain.service.dart';
...
class _CreateTicketScreenState extends State<CreateTicketScreen> {
  ...
  var _selecteddistrict,_selfisers,_selDeart,_seloffice;
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text('Complaint Submitted successfully but supporting documents please proceed',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Center(child: Text('Submit A Complaint')),
        leading: Text(''),
        actions: <Widget>[
          InkWell(
            onTap: () async {
