...
class ReOpenedTicketsScreen extends StatefulWidget {
  @override
  _ReOpenedTicketsScreenState createState() => _ReOpenedTicketsScreenState();
}

class _ReOpenedTicketsScreenState extends State<ReOpenedTicketsScreen> {
  ...
  _getReOpenedTickets() async {
    try {
      ...
      var result = await _ticketService
          .getReOpenedTicketsByUserId(_prefs!.getInt('userId'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('${getTranslated(context, 'ReOpened Tickets')}'),
        actions: <Widget>[
          _isCustomer == true
              ? InkWell(
                  onTap: () {
